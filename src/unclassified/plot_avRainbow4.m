function varargout = plot_avRainbow4(vcf, avsd, summaryInfoTable, avColors, selSmltIds, varargin)
...
for ksai = 1 : opVars.avIndInterval : nsmlt
    ...
    plot_avDistribution(avsd{ksai}, 1, 'linewidth',tmpLw, 'color', avColors(ksai, :));
    hold on 
end
